...
<template>
<div>
  <h1>YouTube Video Comment Thread</h1>
  <el-input placeholder="Video ID" v-model="videoId"></el-input>
  <el-button type="primary">Start Query</el-button>
  <el-row>
    <el-col :span="24">
...
export default {
  ...
  data() {
    return {
       ...
       */
      googleSignInParams: {
        client_id: '687107338706-h3v0lagrb55e1ps176agjn7gqshqq0it.apps.googleusercontent.com'
      }
    }
  }
}
